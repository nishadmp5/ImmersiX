  ...
  return (
    ...
    >
      <div className="flex items-center px-5 lg:px-7.5 xl:px-10 max-lg:py-4">
        <a className=" w-[12rem] xl:mr-8 flex items-center justify-between gap-3" href="#hero">
          <img src={brainwave} width={60} height={10} alt="Brainwave" />
          <h2 className="text-3xl">ImmersiX</h2>
        </a>
